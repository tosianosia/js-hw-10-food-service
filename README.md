...
- Создан репозиторий `js-hw-10-food-service`.
...
Ниже указана разметка элемента меню, которая должна получаться по шаблону
(данные будут разные для каждого объекта).
